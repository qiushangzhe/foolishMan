...
function save(input,output,fileName,componentDirPath,styleType, templateType, type, isChange = false, scriptType) {
  ...
  if(type === 'vue') {
    ...
    buffer = buffer.replace(/{{scriptType}}/g, scriptType)
...
module.exports = (fileName, type,  styleType, templateType, scriptType)=>{
  ...
  save('/template.vue', 'index.vue', fileName, dirPath, styleType, templateType, 'vue', false, scriptType);
